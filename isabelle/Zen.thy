...
next
  ...
  have reconfig_eq[simp]: "reconfig' = reconfig" unfolding reconfig'_def reconfig_def isCommitted_eq v\<^sub>c_eq era\<^sub>i_eq ..
  have Q_eq[simp]: "Q' = Q" unfolding Q'_def Q_def reconfig_eq v\<^sub>c_eq ..
